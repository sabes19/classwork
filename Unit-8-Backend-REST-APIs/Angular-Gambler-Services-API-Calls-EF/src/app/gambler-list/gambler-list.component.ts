...
import { GamblerService }    from '../gambler.service-api'; // access the GamblerServices service
import { RouterLink }        from '@angular/router';

@Component({
  selector: 'gambler-list',
  standalone: true,
  imports: [CommonModule, RouterLink],
  templateUrl: './gambler-list.component.html',
  styleUrl:    './gambler-list.component.css'
})
...
export class GamblerListComponent implements OnInit {  
...
//     var-name   : data-type
public gamblerList : any[] = []; // This is an array of MoviesInfo objects
